    ...
    <section className="mx-auto max-w-2xl">
      <div className="section-hero px-6 py-8 md:px-8">
        <div className="relative z-10">
          <p className="hero-eyebrow border-emerald-300/70 bg-emerald-100/80 text-emerald-900 dark:border-emerald-900/70 dark:bg-emerald-950/40 dark:text-emerald-200">
